...
- [ ] v0.5: Add Curses (basically game modifiers), which add those threats. Also add upgrades and a "breakroom" for the Player.
- [ ] v0.6: Design more and better maps
- [ ] v0.7: Revamp everything to allow for modding support.
